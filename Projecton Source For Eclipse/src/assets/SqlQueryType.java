...
public enum SqlQueryType {
	...
	SELECT_ALL_CHANGE_REQUESTS_BY_INITIATOR_NAME_NOT_COMMITTEE(SqlExecutionType.EXECUTE_QUERY),
	SELECT_ALL_CHANGE_REQUESTS_BY_INITIATOR_NAME_COMMITTEE_MEMBER(SqlExecutionType.EXECUTE_QUERY),
	SELECT_ALL_CHANGE_REQUESTS_BY_INITIATOR_NAME_COMMITTEE_DIRECTOR(SqlExecutionType.EXECUTE_QUERY),
	SELECT_ANALYSIS_STEP_CHANGE_REQUESTS_BY_INITIATOR_NAME(SqlExecutionType.EXECUTE_QUERY),
	SELECT_EXECUTION_STEP_CHANGE_REQUESTS_BY_INITIATOR_NAME(SqlExecutionType.EXECUTE_QUERY),
	SELECT_TESTER_STEP_CHANGE_REQUESTS_BY_INITIATOR_NAME(SqlExecutionType.EXECUTE_QUERY),
	/*TODO: Add Committee queries */
